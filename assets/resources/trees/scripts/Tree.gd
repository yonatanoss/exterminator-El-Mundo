...
var durability = 100
var spawned = true
const Player_Data = preload("res://map/PlayerData.gd")
onready var PlayerData = Player_Data.new()
export (String) var skill_key = "wood"
...
var sounds = preload("res://assets/resources/trees/scripts/Sounds.gd").new(self)
